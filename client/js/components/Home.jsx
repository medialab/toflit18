...
<p>TOFLIT18 is the result of the collaboration of data scientists, economists and historians. It started as a project funded by the Agence Nationale de la Recherche in 2014. <a style='color:white' href='http://toflit18.hypotheses.org'>http://toflit18.hypotheses.org</a></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-6">
                ...
                <p><b>Source code of the exploration tool</b>
