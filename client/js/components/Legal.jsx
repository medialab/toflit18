        ...
        <div className="container content">
          ...
          <div className="row">
            <div className="col-sm-10 col-sm-offset-1">
              <h2>Hosting</h2>
              <p>
                This internet site is hosted by Fondation Nationale des Sciences Politiques (FNSP), Sciences Po -
          ...
          <div className="row">
            <div className="col-sm-10 col-sm-offset-1">
              ...
              <p>
                The full data collected by the project is available is available under ODbL license on github {" "}
              ...
              <p>
                ...
                distributed or reused in any manner, without the written consent of Sciences Po.
                <br />
                The Sciences Po site’s title, concept and form, as well as its content, such as news, descriptions,
                illustrations and original images and their organisation, and any software compilation, source code and
                other elements contained on the Sciences Po site are the property of Sciences Po.
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-10 col-sm-offset-1">
              ...
              <p>
                Our pages also contain links to other sites for which we are in no manner responsible, neither regarding
                their adhesion to public order or good conduct, on the one hand, nor regarding their personal data
                privacy policies and use, on the other.
                <br />
