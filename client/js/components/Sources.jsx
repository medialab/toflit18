          ...
          <div className="text-heading">
            <div className="row">
              ...
              <div className="col-sm-8 col-md-5">
                <p className="hidden-xs">The archives of French eighteenth century trade have been preserved in many different formats. We had to integrate them into a limited number of types depending on their content.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-10 col-sm-offset-1">
              <h2>National best guess</h2>
               <p className="lead">autoselects each year the best source about trade by product x partner for the whole of France.</p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>Local best guess</h2>
               <p className="lead">autoselect each year the best source about trade by product x partner x direction</p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>National</h2>
               <p className="lead">sources contain data for the whole of France.</p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>1792 first semester</h2>
               <p className="lead">contains trade by product x partner for the whole of France for the first semester of 1792. They include mainly quantities.</p>
               <p>AN F12 252</p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>1792-both semester</h2>
               <p className="lead">contains trade by product x continent for the whole of Frane for 1792. They contain a mix of quantities and values (but never both for a single flow)</p>
               <p>AN F12 252</p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>Divers</h2>
               ...
               <p><ul>
                  ...
                  <li>Tableau Général 1839</li></ul></p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>National partenaires manquants</h2>
               <p className="lead">contain trade by product x partner for the whole of France and a small number of partners (Angleterre, Barbarie, États-Unis, Russie for individual years in the 1780s).</p>
               <p><ul>
                  <li>AN F12 1835</li>
                  <li>AN F12 250</li> 
                </ul></p>
            ...
            <div className="col-sm-10 col-sm-offset-1">
              <h2>National toutes directions partenaires manquant</h2>
               <p className="lead">They contain trade by product x partner x direction for the whole of France and some partners.</p>
               <p><ul>
                  <li>AN F12 1666</li>
                  <li>AN F12 1667</li>
            ...
            <div className="col-sm-10 col-sm-offset-1">
              <h2>National toutes directions tous partenaires</h2>
               <p className="lead">contain trade by product x partner x direction for the whole of France. They includes values and quantities. They only exist for 1750 (though the 1789 year is nearly covered in the same way)</p>
               <p><ul>
             ...
             <div className="col-sm-10 col-sm-offset-1">
              <h2>Objet Général</h2>
               <p className="lead">were produced from 1752 to 1788. They contain trade by product x partner for the whole of France. They always include the value of the flows. From 1771, they include quantities and / or unit prices.</p>
               <p><ul>
                  <li>AN F12 1835</li>
                  <li>AN F12 242</li>
                  <li>AN F12 243</li>
             ...
             <div className="col-sm-10 col-sm-offset-1">
              <h2>Résumé</h2>
               <p className="lead">cover the 1787-1789 and 1797-1821. They contain trade by class of products x partner for the whole of France. They include the value of the flows.</p>
               <p><ul>
                  <li>AN F12 251</li>
                </ul></p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>Tableau des quantités</h2>
               <p className="lead">covers 1822 and 1823. It contains trade by product x partner for the whole of France. They include mainly quantities.</p>
               <p><ul>
                  <li>AN F12 251</li>
                </ul></p>
            </div>
             <div className="col-sm-10 col-sm-offset-1">
              <h2>Tableau des marchandises</h2>
               <p className="lead">covers 1819 and 1821. It contains trade by product for the whole of France. They include mainly quantites and tolls paid.</p>
               <p><ul>
                  <li>AN F12 251</li>
                </ul></p>
            </div>
            <div className="col-sm-10 col-sm-offset-1">
              <h2>Tableau Général</h2>
               <p className="lead">include bilateral trade from 1716. We have completed the original ""Tableau Général"" with various other sources giving the same information up to 1792.</p>
               <p><ul>
             ...
             <div className="col-sm-10 col-sm-offset-1">
              <h2>Local</h2>
               <p className="lead">sources contain data for trade by a specific direction by product x partner x direction. They include unit prices and quantites (and sometimes also values). They exist from 1714 to 1780.</p>
               <p><ul>
