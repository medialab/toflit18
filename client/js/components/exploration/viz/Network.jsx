...
export default class Network extends Component {
  ...
  render() {
    ...
    return (
      <div id="sigma-graph" ref="mount" className={className}>
    ...
    return (
      <div className="viz-tools">
        <div className="viz-actions">
          ...
          <button className="btn btn-default btn-xs btn-icon" onClick={toggleLayout}>
        ...
        <div className="viz-nav">
          <button className="btn btn-default btn-xs btn-icon" onClick={this.rescale}>
            <Icon name="icon-localisation" />
          </button>
          <button className="btn btn-default btn-xs btn-icon" onClick={this.zoom}>
            <Icon name="icon-zoom-in" />
          </button>
          <button className="btn btn-default btn-xs btn-icon" onClick={this.unzoom}>
            <Icon name="icon-zoom-out" />
          </button>
          <button className="btn btn-default btn-xs btn-icon" onClick={toggleFullScreen}>
