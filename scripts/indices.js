...
const indices = [
  ...
  { type: "index", label: "Flow", property: "nationalProductBestGuess" },
  { type: "index", label: "Flow", property: "nationalGeographyBestGuess" },
  { type: "index", label: "Flow", property: "localProductBestGuess" },
  { type: "index", label: "Flow", property: "localGeographyBestGuess" },
